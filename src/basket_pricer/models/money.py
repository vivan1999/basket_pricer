...
class Money:
    ...
    def __init__(self, amount: Union[int, str, float, Decimal]):
        try:
            ...
            logger.info("only accepts number as a str, float, int, and decimal as the amount.")
    ...
    def to_decimal(self, value: Union[int, str, float, Decimal]) -> Decimal: # handling all possible types of values
